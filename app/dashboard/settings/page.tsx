        ...
        <TabsContent value="general" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure default settings for automations
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Limit automated actions per hour
                  </p>
                </div>
                <Input
                  type="number"
        ...
        <TabsContent value="notifications" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure chatbot notification settings
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Response Failures</Label>
                  <p className="text-sm text-muted-foreground">
                    Alert when chatbot fails to respond
                  </p>
                </div>
                <Switch defaultChecked />
              </div>
